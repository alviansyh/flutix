...
class TicketDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () {
        context.read<PageBloc>().add(GoToMainPage(bottomNavBarIndex: 1, isExpired: ticket.time.isBefore(DateTime.now())));
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(image: NetworkImage(imgBaseUrl + "w500" + ticket.movieDetail.backdropPath), fit: BoxFit.cover),
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              Text(
                                "Cinema",
                                style: greyTextFont.copyWith(fontSize: 16, fontWeight: FontWeight.w400),
                              ),
                              SizedBox(
