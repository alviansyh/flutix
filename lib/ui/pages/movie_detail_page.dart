                        ...
                        children: <Widget>[
                                ...
                                children: <Widget>[
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        image: DecorationImage(image: NetworkImage(imgBaseUrl + "w1280" + movie.backdropPath ?? movie.posterPath), fit: BoxFit.cover)),
                                  ),
                                  Container(
                                    height: 271,
                                    width: double.infinity,
                                    decoration: BoxDecoration(
                                        gradient: LinearGradient(begin: Alignment(0, 1), end: Alignment(0, 0.06), colors: [Colors.white, Colors.white.withOpacity(0)])),
                                  )
                                ],
                              ),
                              Container(
                                  ...
                                  return SizedBox(
                                    ...
                                    child: ListView.builder(
                                        ...
                                        itemBuilder: (_, index) => Container(
                                            margin: EdgeInsets.only(left: (index == 0) ? defaultMargin : 0, right: (index == credits.length - 1) ? defaultMargin : 16),
                          ...
                          Container(
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                context.read<PageBloc>().add(GoToSelectSchedulePage(movieDetail));
                              },
