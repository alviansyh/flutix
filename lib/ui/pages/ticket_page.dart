                            ...
                            children: [
                              Text(
                                ...
                                style: whiteTextFont.copyWith(
                                  fontSize: 16,
                                  color: !isExpiredTickets ? CupertinoColors.white : CupertinoColors.inactiveGray,
                                ),
                              ),
                              SizedBox(
                                height: 15,
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      ...
      itemBuilder: (_, index) => GestureDetector(
        onTap: () {
          // context.read<PageBloc>().add(GoToTicketDetailPage(sortedTickets[index]));
        },
        child: Container(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage(imgBaseUrl + 'w500' + sortedTickets[index].movieDetail.posterPath),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
