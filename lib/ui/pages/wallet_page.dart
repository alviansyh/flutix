...
class WalletPage extends StatelessWidget {
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                    ...
                                    boxShadow: [BoxShadow(color: Colors.black26, blurRadius: 10, spreadRadius: 0, offset: Offset(0, 5))]),
                                child: Stack(
                                  children: <Widget>[
                                    ClipPath(
                                    ...
                                    Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          Row(
                                            children: <Widget>[
                                              Container(
                                                ...
                                                decoration: BoxDecoration(shape: BoxShape.circle, color: Color(0xFFFFF2CB)),
                                              ),
                                              Container(
                                                width: 30,
                                                height: 30,
                                          ...
                                          Text(
                                            NumberFormat.currency(locale: 'id_ID', symbol: 'IDR ', decimalDigits: 0).format((userState as UserLoaded).user.balance),
                              ...
                              FutureBuilder(
                                  future: FlutixTransactionServices.getTransaction((userState as UserLoaded).user.id),
                                  builder: (_, snapshot) {
                                    if (snapshot.hasData) {
  ...
  Column generateTransactionList(List<FlutixTransaction> transactions, double width) {
