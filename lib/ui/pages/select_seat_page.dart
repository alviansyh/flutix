...
class _SelectSeatPageState extends State<SelectSeatPage> {
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        context.read<PageBloc>().add(GoToSelectSchedulePage(widget.ticket.movieDetail));
                ...
                Column(
                  children: <Widget>[
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(image: NetworkImage(imgBaseUrl + 'w154' + widget.ticket.movieDetail.posterPath), fit: BoxFit.cover),
                                ),
                              )
                            ],
                          ),
                    ...
                    Container(
                      ...
                      width: 277,
                      height: 84,
                      decoration: BoxDecoration(image: DecorationImage(image: AssetImage("assets/screen.png"))),
                    ),
                    // note: SEATS
                    generateSeats(),
                    // note: NEXT BUTTON
