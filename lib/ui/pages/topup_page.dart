...
class _TopUpPageState extends State<TopUpPage> {
  ...
  Widget build(BuildContext context) {
    context.read<ThemeBloc>().add(ChangeTheme(ThemeData().copyWith(primaryColor: Color(0xFFE4E4E4))));
                      ...
                      SizedBox(
                        ...
                        child: BlocBuilder<UserBloc, UserState>(
                          builder: (_, userState) => ElevatedButton(
                            ...
                            child: Text(
                              "Top Up My Wallet",
                              style: whiteTextFont.copyWith(fontSize: 16, color: (selectedAmount > 0) ? Colors.white : Color(0xFFBEBEBE)),
                            ),
                          ),
                        ),
                      ),
