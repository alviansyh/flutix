...
class UpcomingMovieDetailPage extends StatelessWidget {
  final Movie movie;

  UpcomingMovieDetailPage(this.movie);
                                  ...
                                  decoration: BoxDecoration(
                                      image: DecorationImage(
                                          image: NetworkImage(
                                                      movie.backdropPath !=
                                                  null
                                              ? imgBaseUrl + "w1280" + movie.backdropPath
                                              : imgBaseUrl + "w1280" + movie.posterPath),
                                          fit: BoxFit.cover)),
                                ),
                                Container(
                                  height: 271,
